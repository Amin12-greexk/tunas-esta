...
export default async function SertifikasiPage() {
  const sertifikasi = await fetchSanity<Sertifikasi[]>(qAllSertifikasi);

  const certBenefits = [
    { icon: Shield, title: "Quality Assurance", description: "All products meet international standards" },
    { icon: Award, title: "Global Recognition", description: "Certified by leading international bodies" },
    { icon: CheckCircle, title: "Food Safety", description: "HACCP and ISO 22000 compliant" },
    { icon: FileCheck, title: "Regular Audits", description: "Continuous monitoring and improvement" },
  ];
  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="relative py-24 bg-gradient-to-br from-brand-600 via-brand-700 to-brand-800 overflow-hidden">
        ...
        <div className="container relative">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6">Our Certifications</h1>
      ...
      <section className="py-16 bg-gradient-to-b from-white to-zinc-50">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-zinc-900 mb-4">Why Certifications Matter</h2>
      ...
      <section className="py-16 bg-white">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-zinc-900 mb-4">Our Active Certifications</h2>
          ...
          {sertifikasi?.length ? (
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              {sertifikasi.map((cert) => (
                <CertificationCard key={cert._id} {...cert} />
              ))}
            </div>
          ) : (
